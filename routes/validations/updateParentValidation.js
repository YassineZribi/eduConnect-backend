...
const updateParentProfil = (reqBody) => {
    const schema = Joi.object({
        ...
        accountName: Joi.string().min(6).max(50).empty().required().messages({
            ...
            "string.min": "\"accountName\" should have a minimum length of 3 ",
            "string.max": "\"accountName\" should have a maximum length of 20",
            "string.empty": "Ce champ doit être rempli !",
...
module.exports = { updateParentProfil, updateParentProfilValidationByHim, updateMainPhoneNumber, updateOptionalPhoneNumber, updatePasswordValidation };
